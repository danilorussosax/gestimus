...
| [`docs/TEST.md`](docs/TEST.md) | **Testing & verification** (Italian) — test pyramid (unit/server/E2E/type-check/load), commands, prerequisites, load-test reference results, CI gates |
